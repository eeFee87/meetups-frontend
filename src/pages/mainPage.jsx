    ...
    <div className='flex flex-col min-h-screen gap-20'>
      <Header title='Meetup-App'>
        ...
        {authUser && (
          <button
            onClick={() => authLogout()}
            className='h-10 w-24 px-3  text-sm font-medium text-center text-white bg-teal-700 rounded-lg hover:bg-teal-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-teal-800'
          >
            LogOut
          </button>
        )}
